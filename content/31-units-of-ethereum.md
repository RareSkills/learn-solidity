...
If you feel like counting, that’s 10^18. Remember, there aren’t floats in Solidity, so "1 Ether" is actually 10^18 units of its smallest unit.
...
By the way, even though floats are not supported in Solidity, you can specify fractions of an Ether. The Solidity compiler is smart enough to understand that a fraction of an Ether isn’t a fraction itself. The following lines of code are equivalent.
